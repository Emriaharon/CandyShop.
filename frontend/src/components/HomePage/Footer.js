              ...
              <Column>
                <AboutUsCol>
                  ...
                  <FooterLink style={{ fontSize: "20px", paddingBottom: "5%" }}>
                    Candy Shop is a company with a
                    reputation of more than 40 years.
                    The store has a huge selection of
                    chocolates, sweets, drinks,
                    gift packs and other luxury sweets
                    from all the leading brands in the world.
                  </FooterLink>
                </AboutUsCol>
              </Column>
            </Grid>
